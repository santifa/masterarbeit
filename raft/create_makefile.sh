...
# insert the master file
remfiles=("raft")
allfiles=("raft")
folders=("" "coq-tools/" "velisarios/components/" "velisarios/" "src/" "src/PrimaryBackup/" "src/example/")
...
{ echo ""; echo "default : raft.vo"; } >> Makefile

echo "" >> Makefile
echo "clean :" >> Makefile
echo "	find . -name \"*.aux\" -o -name \"*.vo\" -o -name \"*.glob\" | xargs rm" >> Makefile
...
for i in "${!aa[@]}"; do
    ...
    echo "" >> Makefile
    echo "	coqc -R coq-tools Tools -R velisarios Velisarios -R src Raft ${i}.v" >> Makefile
done
