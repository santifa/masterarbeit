...
fun get9Children term =
	...
	[term1, term2, term3, term4, term5, term6, term7, term8, term9] => (term1, term2, term3, term4, term5, term6, term7, term8, term9)
      | _ => raise EH.Impossible "term is supposed to have 9 children"
...
fun get10Children term =
	...
	[term1, term2, term3, term4, term5, term6, term7, term8, term9, term10] => (term1, term2, term3, term4, term5, term6, term7, term8, term9, term10)
      | _ => raise EH.Impossible "term is supposed to have 10 children"
...
fun prod2class SCON_INT    = SCON
  ...
  (* TATOM *)
  | prod2class TATOM_G = TATOM
  (* ATOMELT *)
  | prod2class ATOMELT_BASE  = ATOMELT
  | prod2class ATOMELT_BASEL = ATOMELT
  | prod2class ATOMELT_SEND  = ATOMELT
  | prod2class ATOMELT_BCAST = ATOMELT
  | prod2class ATOMELT_MSG   = ATOMELT
  (* ATOMELTS *)
  | prod2class ATOMELTS_ELTS = ATOMELTS
  (* DEC *)
...
(*fun getRegAtomMrule (N {kind = (MRULE, MRULE_C), label, value, regions, parents, children = [atoms, _]}) = getRegions atoms
  | getRegAtomMrule _ = raise EH.Impossible "term is not a mrule"*)
...
fun getIdIdent (N {kind = (ID, ID_VID),   label, value, regions, parents, children = []}) = value
  ...
  | getIdIdent term = raise EH.Impossible "term is not an identifier"
...
(*fun flattenPatTyped (N {kind = (PAT, PAT_TYPED), label, value, regions, parents, children = [pat, typ]}) = (pat, typ)
  | flattenPatTyped _ = raise EH.Impossible "Not a typed pattern"

fun flattenPatApp (N {kind = (PAT, PAT_APP), label, value, regions, parents, children = [id, atpat]}) =
    if isIdVid id
    then (id, [atpat])
    else raise EH.Impossible "Not the application of an identifier to arguments"
  ...
  | flattenPatApp pat = raise EH.Impossible "Not the application of an identifier to arguments"*)
...
fun getIdBind (N {kind = (BIND, BIND_DEC), label, value, regions, parents, children = [id, args, exp]}) = getIdIdent id
  | getIdBind _ = raise EH.Impossible unexpectedFormat
...
fun vid2tycon (N {kind = (ID, ID_VID), label, value, regions, parents, children = []}) =
  ...
  | vid2tycon _ = raise EH.Impossible "term is not a vid"
...
fun toStringClass SCON       = "SCON"
  ...
  | toStringClass TATOM      = "TATOM"
  | toStringClass ATOMELT    = "ATOMELT"
  | toStringClass ATOMELTS   = "ATOMELTS"
...
fun toStringProd SCON_INT    = "SCON_INT"
  ...
  (* TATOM *)
  | toStringProd TATOM_G = "TATOM_G"
  (* ATOMELT *)
  | toStringProd ATOMELT_BASE  = "ATOMELT_BASE"
  | toStringProd ATOMELT_BASEL = "ATOMELT_BASEL"
  | toStringProd ATOMELT_SEND  = "ATOMELT_SEND"
  | toStringProd ATOMELT_BCAST = "ATOMELT_BCAST"
  | toStringProd ATOMELT_MSG   = "ATOMELT_MSG"
  (* ATOMELTS *)
  | toStringProd ATOMELTS_ELTS = "ATOMELTS_ELTS"
  (* DEC *)
  ...
  | toStringProd DEC_MSGS     = "DEC_MSGS"
...
fun export (N {kind = (SCON, SCON_INT),    label, value, regions, parents, children = []}) = value
  ...
  | export (N {kind = (EXP, EXP_COMP),     label, value, regions, parents, children = (exp :: exps)}) =
	...
	val (exps', opt) = if String.isSubstring "O" value
  ...
  (* TATOM *)
  | export (N {kind = (TATOM, TATOM_G), label, value, regions, parents, children = [a, t, e]}) = value ^ "(" ^ export a ^ " : " ^ export t ^ export e ^ ")"
  (* ATOMELT *)
  | export (N {kind = (ATOMELT, ATOMELT_BASE),  label, value, regions, parents, children = [id]})      = "base : "      ^ export id
  | export (N {kind = (ATOMELT, ATOMELT_BASEL), label, value, regions, parents, children = [id, exp]}) = "base : "      ^ export id ^ " @ "  ^ export exp
  | export (N {kind = (ATOMELT, ATOMELT_SEND),  label, value, regions, parents, children = [id]})      = "send : "      ^ export id
  | export (N {kind = (ATOMELT, ATOMELT_BCAST), label, value, regions, parents, children = [id]})      = "broadcast : " ^ export id
  | export (N {kind = (ATOMELT, ATOMELT_MSG),   label, value, regions, parents, children = [id]})      = "msg : "       ^ export id
  (* ATOMELTS *)
  | export (N {kind = (ATOMELTS, ATOMELTS_ELTS), label, value, regions, parents, children}) = let val st = exportList children ", " in if st = "" then st else ", " ^ st end
  (* DEC *)
  ...
  | export (N {kind = (DEC, DEC_TYCON),   label, value, regions, parents, children = [s, tc, ty]})     = "cons "      ^ export s ^ " " ^ export tc ^ " : " ^ export ty
  | export (N {kind = (DEC, DEC_EQTYCON), label, value, regions, parents, children = [s, tc, i, ty]})  = "cons "      ^ export s ^ " " ^ export tc ^ ", " ^ export i ^ " : " ^ export ty
  | export (N {kind = (DEC, DEC_TYFUN),   label, value, regions, parents, children = [seq, tc, ty]})   = "type "      ^ export seq ^ " " ^ export tc ^ " = " ^ export ty
  | export (N {kind = (DEC, DEC_MSGS),    label, value, regions, parents, children})                   = "MSGS "      ^ exportList children " "
  ...
  | export (N {kind = (DEC, DEC_INFIX),   label, value, regions, parents, children = [id]})            =
    (if value = "L"
     ...
     then "infixr "
     else raise EH.Impossible "unknown fixity") ^ export id
  ...
  | export (N {kind = (BIND, BIND_IOP),  label, value, regions, parents, children = [id, a1, a2, e]})    = (if value = "L" then "infix " else if value = "R" then "infixr " else raise EH.Impossible "unknow fixity") ^ export id ^ " (" ^ export a1 ^ ", " ^ export a2 ^ ") = " ^ export e
  | export (N {kind = (BIND, BIND_TIOP), label, value, regions, parents, children = [id, a1, a2, t, e]}) = (if value = "L" then "infix " else if value = "R" then "infixr " else raise EH.Impossible "unknow fixity") ^ export id ^ " (" ^ export a1 ^ ", " ^ export a2 ^ ") : " ^ export t ^ " = " ^ export e
  (* BINDS *)
  ...
  (* wrong format *)
  | export term = (print (toString term); raise EH.Impossible wrongFormat)
...
fun freeVId bounds term =
	...
	fun freeBind bind bounds brec =
		...
		in (bounds1, frees)
	      ...
	      | _ => raise EH.Impossible wrongFormat

	fun boundHeaderAtomElt elt =
	    case getKind elt of
		(ATOMELT, ATOMELT_BASE) =>
		let val id = get1Children elt
		in getVIdentsTerm id
		end
	      | (ATOMELT, ATOMELT_BASEL) =>
		let val (id, exp) = get2Children elt
		in getVIdentsTerm id
		end
	      | (ATOMELT, ATOMELT_SEND) =>
		let val id = get1Children elt
		in getVIdentsTerm id
		end
	      | (ATOMELT, ATOMELT_BCAST) =>
		let val id = get1Children elt
		in getVIdentsTerm id
		end
	      | (ATOMELT, ATOMELT_MSG) =>
	...
	fun boundHeaderAtomEltS elts =
	    case getKind elts of
		(ATOMELTS, ATOMELTS_ELTS) =>
		foldr (fn (elt, set) => IDS.union (set, boundHeaderAtomElt elt))
		      IDS.empty
		      (getChildren elts)
	      | _ => raise EH.Impossible wrongFormat

	fun boundHeader header =
	    case getKind header of
		(TATOM, TATOM_G) =>
		let val (atoms, typ, elts) = get3Children header
		in boundHeaderAtomEltS elts
		end
	      | _ => raise EH.Impossible wrongFormat
	...
	fun freeDec dec bounds =
		...
		in (IDS.union (bounds, getVIdentsTerm fid), FREES.empty)
	      ...
	      | (DEC, DEC_MSGS)    =>
		let val bounds' =
			foldr (fn (header, bounds) =>
				  IDS.union (bounds, boundHeader header))
			      bounds
			      (getChildren dec)
		in (bounds', FREES.empty)
		end
	      | (DEC, DEC_QMSG)    =>
		let val (id, atm, typ) = get3Children dec
			...
			case getValue dec of
			    "internal" => IDS.fromList [i ^ "'base", i ^ "'send", i ^ "'broadcast"]
			  | "input"    => IDS.fromList [i ^ "'base"]
			  | "output"   => IDS.fromList [i ^ "'send", i ^ "'broadcast"]
			  | _ => raise Fail ""
    ...
    in case getKind term of
	 ...
	 | (ATOMS,      _)             => FREES.empty
	 | (TATOM,      TATOM_G)       =>
	   let val (atoms, typ, elts) = get3Children term
	   in freeVId bounds elts
	   end
	 | (TATOM,      _)             => FREES.empty
	 | (ATOMELTS,   _)             => freeUnionChildren ()
	 | (ATOMELT,    ATOMELT_BASEL) =>
	   let val (id, exp) = get2Children term
	   in freeVId bounds exp
	   end
	 | (ATOMELT,    _)             => FREES.empty
...
fun unionSUB (sub1, sub2) =
    SUB.unionWith (fn _ => raise EH.Impossible "an identifier should not occur twice in a pattern")
		  (sub1, sub2)
...
fun dummy_stream () : alpha = raise EH.Impossible "the id stream is not set yet"
...
(*fun isNewId string =
    ...
    in if base = ""
       then raise EH.Impossible "the new_id_base is not set"
...
fun getIdentsBind (N {kind = (BIND, BIND_DEC),  label, value, regions, parents, children = [f, a, e]})         = getVIdentsTerm f
  ...
  | getIdentsBind term = (print (toString term); raise EH.Impossible unexpectedFormat)

fun getIdentsAtomElt (N {kind = (ATOMELT, ATOMELT_BASE),  label, value, regions, parents, children = [id]})      = getVIdentsTerm id
  | getIdentsAtomElt (N {kind = (ATOMELT, ATOMELT_BASEL), label, value, regions, parents, children = [id, exp]}) = getVIdentsTerm id
  | getIdentsAtomElt (N {kind = (ATOMELT, ATOMELT_SEND),  label, value, regions, parents, children = [id]})      = getVIdentsTerm id
  | getIdentsAtomElt (N {kind = (ATOMELT, ATOMELT_BCAST), label, value, regions, parents, children = [id]})      = getVIdentsTerm id
  | getIdentsAtomElt (N {kind = (ATOMELT, ATOMELT_MSG),   label, value, regions, parents, children = [id]})      = getVIdentsTerm id
  | getIdentsAtomElt term = (print (toString term); raise EH.Impossible unexpectedFormat)

fun getIdentsAtomElts (N {kind = (ATOMELTS, ATOMELTS_ELTS), label, value, regions, parents, children}) =
    foldr (fn (elt, set) => IDS.union (set, getIdentsAtomElt elt)) IDS.empty children
  | getIdentsAtomElts term = (print (toString term); raise EH.Impossible unexpectedFormat)

fun getIdentsTatom (N {kind = (TATOM, TATOM_G), label, value, regions, parents, children = [a, t, elts]}) = getIdentsAtomElts elts
  | getIdentsTatom term = (print (toString term); raise EH.Impossible unexpectedFormat)
...
fun getIdentsDec (dec as N {kind = (DEC, DEC_LET),      label, value, regions, parents, children = [b]})             = getIdentsBind b
  ...
  | getIdentsDec (dec as N {kind = (DEC, DEC_TYPARAM),  label, value, regions, parents, children = [s, t]})          = IDS.empty
  ...
  | getIdentsDec (dec as N {kind = (DEC, DEC_MSGS),     label, value, regions, parents, children})                   =
    foldr (fn (tatom, set) => IDS.union (set, getIdentsTatom tatom)) IDS.empty children
...
fun transformToPairs' []        _    = raise EH.Impossible "a tuple should at least be a pair"
  | transformToPairs' [_]       _    = raise EH.Impossible "a tuple should at least be a pair"
...
fun fo_subst sub (term as N {kind = (ATEXP, ATEXP_ID), label, value, regions, parents, children = [id]}) =
    ...
    else raise EH.Impossible wrongFormat
  ...
  | fo_subst sub (term as N {kind = (MRULE, MRULE_B), label, value, regions, parents, children = [bpat, exp]}) = raise EH.Impossible "case branches should be dealt with when dealing with case expressions"
    (*let val idents = getVIdentsTerm pat
	val sub'   = SUB.filteri (fn (id, exp) => not (IDS.member (idents, id))) sub
    in updChildren term [pat, fo_subst sub' exp]
    end*)
...
fun fo_ren ren (term as N {kind = (ID, ID_VID), label, value, regions, parents, children = []}) =
  ...
  | fo_ren ren (term as N {kind = (MRULE, MRULE_B), label, value, regions, parents, children = [bpat, exp]}) = raise EH.Impossible "case branches should be dealt with when dealing with case expressions"
...
fun mvPat2Exp (pat as N {kind = (ATPAT, ATPAT_ID),    label, value, regions, parents, children = [id]})  exp1 exp2 =
  ...
  | mvPat2Exp (pat as N {kind = (ATPAT, ATPAT_SCON),  label, value, regions, parents, children = []})       exp1 exp2 = raise EH.Impossible ""
  | mvPat2Exp (pat as N {kind = (ATPAT, ATPAT_LIST),  label, value, regions, parents, children})            exp1 exp2 = raise EH.Impossible ""
  | mvPat2Exp (pat as N {kind = (ATPAT, ATPAT_PAREN), label, value, regions, parents, children = [pat']})   exp1 exp2 = mvPat2Exp pat' exp1 exp2
  | mvPat2Exp (pat as N {kind = (ATPAT, ATPAT_STRUC), label, value, regions, parents, children = [ident]})  exp1 exp2 = raise EH.Unimplemented ""
  | mvPat2Exp (pat as N {kind = (ATPAT, ATPAT_TUPLE), label, value, regions, parents, children = []})       exp1 exp2 = exp2 (*raise EH.Unimplemented ""*)
  ...
  | mvPat2Exp (pat as N {kind = (PAT, PAT_CONS),  label, value, regions, parents, children = [pat1, pat2]}) exp1 exp2 = raise EH.Unimplemented ""
  | mvPat2Exp (pat as N {kind = (PAT, PAT_ATPAT), label, value, regions, parents, children = [atpat]})      exp1 exp2 = mvPat2Exp atpat exp1 exp2
  | mvPat2Exp (pat as N {kind = (PAT, PAT_APP),   label, value, regions, parents, children})                exp1 exp2 = raise EH.Unimplemented ""
  | mvPat2Exp pat exp1 exp2 = (print (toString pat ^ "\n"); raise EH.Impossible "term is not a pattern")

fun generateLambdas params exp =
    let fun toLam [] = exp
	  | toLam (pat :: atpats) =
	    let val exp = toLam atpats
		val (fid, exp') =
		    case getIdPat pat of
			SOME ident =>
			let val id = getIdIdent ident
			in if isParam id
			   then let val id0 = newIdIdSet (getVIdentsTerm exp) "z"
				    val sub = SUB.singleton (id, idToDumExp id0)
			...
			case getAsPat pat of
			  ...
			  | NONE =>
			    let val id   = newIdIdSet (getVIdentsTerm exp) "z"
				val exp' = mvPat2Exp pat (idToDumExp id) exp
			    in (id, exp')
			    end
	    in mk_new_dum_term EXP_LAMBDA "" [] [idToPat fid, exp']
	    end
    in case params of
	 ...
	 | _ => raise EH.Impossible "unexpected term"
    end

(*fun patToExp (N {kind = (ATPAT, ATPAT_ID),    label, value, regions, parents, children = [id]})         = mk_new_dum_term ATEXP_ID    "" [] [id]
  | patToExp (N {kind = (ATPAT, ATPAT_WILD),  label, value, regions, parents, children})                = raise EH.Impossible "wildcards should have been replaced"
  ...
  | patToExp term = raise EH.Impossible "the term is not a pattern"*)
...
fun simplify (term as N {kind = (ATPAT, ATPAT_SCON),  label, value, regions, parents, children = [sc]}) =
  ...
  | simplify (term as N {kind = (TATOM, _),      ...}) = updSimplifyChildren term
  | simplify (term as N {kind = (ATOMELT, _),    ...}) = updSimplifyChildren term
  | simplify (term as N {kind = (ATOMELTS, _),   ...}) = updSimplifyChildren term
  | simplify (term as N {kind = (DOTS, _),       ...}) = updSimplifyChildren term
  (* wrong format *)
  | simplify term = (print (toString term); raise EH.Impossible wrongFormat)
...
and simplifyBind (term as N {kind = (BIND, BIND_DEC),  label, value, regions, parents, children = [f, a, e]})       =
  ...
  | simplifyBind term = (print (toString term); raise EH.Impossible wrongFormat)
...
and simplifyDec (term as N {kind = (DEC, DEC_LET),     label, value, regions, parents, children = [b]})              =
  ...
  | simplifyDec (term as N {kind = (DEC, DEC_MSGS),     ...}) = [updSimplifyChildren term]
  ...
  | simplifyDec (term as N {kind = (DEC, DEC_PARSE),    ...}) = raise EH.Impossible "term is not parsable"
  ...
  | simplifyDec term = (print (toString term); raise EH.Impossible wrongFormat)
...
and simplifyFile (term as N {kind = (FILE, FILE_F), label, value, regions, parents, children}) =
  ...
  | simplifyFile term = (print (toString term); raise EH.Impossible wrongFormat)
...
and simplifyProg (term as N {kind = (PROG, PROG_P), label, value, regions, parents, children}) =
  ...
  | simplifyProg term = (print (toString term); raise EH.Impossible wrongFormat)
